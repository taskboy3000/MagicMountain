package MagicMountain::Service::SeasonFinalizer;
...
sub finalize ($self) {
    ...
    for my $char (@sorted) {
        ...
        my $highlights = $self->_build_highlights($disps, $final_score);
    ...
    $season->nullCol('faction_climate');
...
sub _build_highlights ($self, $disps, $final_score) {
